    ...
    items: [
      {
        id: 'u-4-1',
        title: 'Profil Saya',
        subtitle: 'Kelola identitas akun, nama pengguna, dan nomor WA',
        iconName: 'User',
        tab: 'login',
        badge: 'Profil'
      },
...
export const ADMIN_CATEGORIZED_MENUS: AdminMenuCategory[] = [
  {
    ...
    items: [
      ...
      {
        id: 'adm-1-3',
        title: 'Kalender & Jadwal Turnamen',
        subtitle: 'Atur tanggal turnamen, timeline pendaftaran & countdown',
        iconName: 'Calendar',
        adminTab: 'jadwal',
        badge: 'Kalender'
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'adm-2-3',
        title: 'Pendaftaran Turnamen Mendatang',
        subtitle: 'Kelola slot awal & registrasi peserta turnamen mendatang',
        iconName: 'Sparkles',
  ...
  },
  {
    ...
    badge: '6 Menu (Khusus Admin Utama 🔒)',
    themeColor: {
