...
export const ADMIN_MENUS_40 = [
  ...
  { id: 27, title: "BUAT JADWAL TURNAMEN", adminTab: "turnamen", description: "Siapkan nama turnamen, tanggal buka/tutup, slot, fee, & prizepool." },
  ...
  { id: 32, title: "PENGATURAN SINKRONISASI DATA", adminTab: "sinkronisasi-data", description: "Memastikan data di Website & Aplikasi selalu sama dan terbarui serentak." },
