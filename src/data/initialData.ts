import { RegisteredTeam, RuleCategory, CommunityGroup, MatchSchedule, TransactionRecord, PastWinner, SiteConfig, AdminAccount, HomeConfig, PrizePoolConfig, AnnouncementItem, RegistrationFormConfig, ShareConfig, HelpItem, UserAccount, BlacklistEntry, PaymentMethodsConfig, WaBotConfig, TournamentInfo, BackgroundMusicConfig, OperatingHoursConfig, SecuritySettingsConfig, WebsiteIdentityConfig } from '../types';
...
export const TOURNAMENT_FF_INFO: TournamentInfo = {
  ...
  tournamentStage: 'Pendaftaran Terbuka',
