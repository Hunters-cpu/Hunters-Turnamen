...
import { TabType, TournamentInfo, PrizePoolConfig } from '../../types';
            ...
            <div className="flex flex-col items-end gap-1.5 w-full sm:w-auto">
              ...
              {isAdmin && (
                <button
                  ...
                  className="text-[11px] bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 border border-amber-500/40 px-3 py-1 rounded-lg font-bold flex items-center gap-1 transition-all"
                >
                  <span>✏️ Edit Total Hadiah FF</span>
                </button>
              )}
            </div>
          </div>
            ...
            <div className="flex flex-col items-end gap-1.5 w-full sm:w-auto">
              ...
              {isAdmin && (
                <button
                  type="button"
                  onClick={() => setActiveTab('admin')}
                  className="text-[11px] bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-300 border border-cyan-500/40 px-3 py-1 rounded-lg font-bold flex items-center gap-1 transition-all"
                >
                  <span>✏️ Edit Total Hadiah MLBB</span>
                </button>
              )}
            </div>
          </div>
