        ...
        <div className="p-4 sm:p-6 overflow-y-auto space-y-5 text-xs text-neutral-300">
          {!isSuccess ? (
            <form onSubmit={handleSubmitPayment} className="space-y-5">
              ...
              <div className="bg-[#050505] p-4 rounded-2xl border border-neutral-800 flex items-center justify-between">
                <div>
                  <span className="text-[10px] text-neutral-400 uppercase font-bold block">Nominal Biaya Wajib Transfer:</span>
