      ...
      <div className="bg-[#0c0d14] border-2 border-amber-500/70 rounded-3xl max-w-md w-full p-5 sm:p-6 text-white shadow-2xl relative space-y-4 my-auto">
        ...
        {!isSuccess ? (
          <div className="space-y-4 text-center">
            ...
            {/* NOMINAL HERO CARD */}
            <div className="bg-gradient-to-r from-amber-950/80 via-yellow-950/40 to-slate-950 p-3.5 rounded-2xl border-2 border-amber-500/80 space-y-0.5 shadow-lg">
              ...
              <p className="text-[11px] text-slate-300">
                Nominal: <strong className="text-white font-mono">{formatRupiah(amount)}</strong> — Pembayaran diproses oleh <strong className="text-amber-400">Saweria</strong>
              </p>
            </div>
